...
def run(args):
    ...
    for img_name in images:
        ...
        if y not in type_score:
            type_score[y] = [dist]
        type_score[y].append(dist)
    ...
    print("SUBJECT LABEL: {} with average score/distance of {}".format(type_label, min))
    print("All subject average distance scores from query image:")
